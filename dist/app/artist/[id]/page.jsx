...
async function ArtistPage({ params }) {
    ...
    const artistBgImage = ((_b = (_a = artist.images) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.url)
        ...
        : "none";
    return (<div className="flex flex-col text-white bg-secondary min-h-screen">
      {/* Hero / Banner Section */}
      <div className="relative w-full h-[400px] bg-center bg-cover flex items-end p-8" style={{
      ...
      <div className="p-[40px]">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col">
            {topTracks.map((track) => {
            var _a, _b;
            return (<LongSongCard_1.default key={track.id} title={track.name} artist={track.artists.map((a) => a.name).join(", ")} album={track.album.name} date={track.album.release_date || "Unknown"} duration={formatDuration(track.duration_ms)} cover={(_b = (_a = track.album.images) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.url}/>);
        })}
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="mt-8">
              ...
              <AlbumCarousel_1.default albums={albums} artistName={artist.name}/>
            </div>
          </div>
        </div>
      </div>
